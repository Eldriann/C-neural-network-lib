...
/***< Replay memory */
	...
	*/
	struct nn_neural_layer_s {
		...
		nn_matrix_t *outputs;
		/***< Outputs of this layer (used for learning) */
	};

	/***
	** \brief Structure representing a neural network
	**
	** Will be rework later to move to multi hiden layer and deep learning.
	*/
...
nn_matrix_t *inputs);
	...
	** Will return 84 if the learning failed, 0 otherwise.
	*/

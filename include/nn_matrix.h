...
/**
** \file nn_matrix.h
** \brief Header declaring matrix functions
**
** All matrix related stuff is in this header file
*/
	...
	*/
	struct nn_matrix_s {
		int nb_columns; /**< Nb columns in the matrix */
		int nb_rows; /**< Nb rows in the matrix */
		float **values; /**< All the matrix values */
	};
